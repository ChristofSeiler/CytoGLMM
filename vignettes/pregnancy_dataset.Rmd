...
We reanalyze mass cytometry data from @aghaeepour2017immune. We can download the original `fcs` files from [FlowRepository](http://flowrepository.org/id/FR-FCM-ZY3Q). Here, we will focus on a subset of the original data: whole blood samples collected from 16 women during pregnancy stimulated with IFNa.
