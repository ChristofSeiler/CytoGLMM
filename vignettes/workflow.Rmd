...
Gate with `openCyto` according to supplementary material (Fig. S1) from [@saghaeepour2017immune].
...
# Regression Analysis of NK Cells

For the regression analysis, we will again focus only on NK cells subset stored in `df_samples_subset`.
