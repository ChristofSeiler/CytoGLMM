...
Instead of modeling the donor effect, we can use bootstrap resampling. This also an option if we do not have samples repeated (under different conditions) from the same donor.
...
Fit a mixture of regression model to identity if there are clusters of donors.
