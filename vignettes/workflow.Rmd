...
Instead of modeling the donor effect, we can use bootstrap resampling. In our experiences, this type of regression gives also good results when samples are not matched between conditions on the same donor.
